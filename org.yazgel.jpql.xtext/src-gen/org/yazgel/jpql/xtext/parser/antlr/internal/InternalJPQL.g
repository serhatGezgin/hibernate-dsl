...
entryRuleLITERAL_TEMPORAL returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getLITERAL_TEMPORALRule()); } 
	 iv_ruleLITERAL_TEMPORAL=ruleLITERAL_TEMPORAL 
	 { $current=$iv_ruleLITERAL_TEMPORAL.current.getText(); }  
	 EOF 
;

// Rule LITERAL_TEMPORAL
ruleLITERAL_TEMPORAL returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(    this_DATE_LITERAL_0=RULE_DATE_LITERAL    {
    ...
    |    this_TIME_LITERAL_1=RULE_TIME_LITERAL    {
    ...
    |    this_TIMESTAMP_LITERAL_2=RULE_TIMESTAMP_LITERAL    {
