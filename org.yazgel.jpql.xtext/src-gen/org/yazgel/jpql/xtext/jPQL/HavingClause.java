 ...
 * <ul>
 *   <li>{@link org.yazgel.jpql.xtext.jPQL.HavingClause#getHaving <em>Having</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.yazgel.jpql.xtext.jPQL.JPQLPackage#getHavingClause()
 * @model
 * @generated
 */
public interface HavingClause extends EObject
{
   ...
   * @see org.yazgel.jpql.xtext.jPQL.JPQLPackage#getHavingClause_Having()
  ...
  /**
   * Sets the value of the '{@link org.yazgel.jpql.xtext.jPQL.HavingClause#getHaving <em>Having</em>}' containment reference.
   * <!-- begin-user-doc -->
   * <!-- end-user-doc -->
