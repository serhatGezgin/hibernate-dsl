 ...
 * <ul>
 *   <li>{@link org.yazgel.jpql.xtext.jPQL.impl.SomeExpressionImpl#getQuery <em>Query</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SomeExpressionImpl extends ExpressionImpl implements SomeExpression
{
  ...
  {
    return JPQLPackage.Literals.SOME_EXPRESSION;
  }
  ...
  public NotificationChain basicSetQuery(SelectStatement newQuery, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JPQLPackage.SOME_EXPRESSION__QUERY, oldQuery, newQuery);
  ...
  public void setQuery(SelectStatement newQuery)
  {
    if (newQuery != query)
    {
      ...
      if (query != null)
        msgs = ((InternalEObject)query).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JPQLPackage.SOME_EXPRESSION__QUERY, null, msgs);
      if (newQuery != null)
        msgs = ((InternalEObject)newQuery).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JPQLPackage.SOME_EXPRESSION__QUERY, null, msgs);
      msgs = basicSetQuery(newQuery, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JPQLPackage.SOME_EXPRESSION__QUERY, newQuery, newQuery));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JPQLPackage.SOME_EXPRESSION__QUERY:
