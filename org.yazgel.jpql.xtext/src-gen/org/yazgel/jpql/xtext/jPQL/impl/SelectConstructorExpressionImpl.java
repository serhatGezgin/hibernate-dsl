 ...
 * <ul>
 *   <li>{@link org.yazgel.jpql.xtext.jPQL.impl.SelectConstructorExpressionImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.yazgel.jpql.xtext.jPQL.impl.SelectConstructorExpressionImpl#getItems <em>Items</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SelectConstructorExpressionImpl extends SelectExpressionImpl implements SelectConstructorExpression
{
  ...
  {
    return JPQLPackage.Literals.SELECT_CONSTRUCTOR_EXPRESSION;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JPQLPackage.SELECT_CONSTRUCTOR_EXPRESSION__NAME, oldName, name));
  }
  ...
  public EList<AliasAttributeExpression> getItems()
  {
    if (items == null)
    {
      items = new EObjectContainmentEList<AliasAttributeExpression>(AliasAttributeExpression.class, this, JPQLPackage.SELECT_CONSTRUCTOR_EXPRESSION__ITEMS);
    }
    return items;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JPQLPackage.SELECT_CONSTRUCTOR_EXPRESSION__ITEMS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case JPQLPackage.SELECT_CONSTRUCTOR_EXPRESSION__NAME:
        return getName();
      case JPQLPackage.SELECT_CONSTRUCTOR_EXPRESSION__ITEMS:
        return getItems();
    }
