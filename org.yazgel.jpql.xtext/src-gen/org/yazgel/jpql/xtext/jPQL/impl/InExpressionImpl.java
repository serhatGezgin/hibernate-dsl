 ...
 * <ul>
 *   <li>{@link org.yazgel.jpql.xtext.jPQL.impl.InExpressionImpl#getLhs <em>Lhs</em>}</li>
 *   <li>{@link org.yazgel.jpql.xtext.jPQL.impl.InExpressionImpl#isIsNot <em>Is Not</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InExpressionImpl extends ExpressionImpl implements InExpression
{
  ...
  public NotificationChain basicSetLhs(Variable newLhs, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, JPQLPackage.IN_EXPRESSION__LHS, oldLhs, newLhs);
  ...
  public void setLhs(Variable newLhs)
  {
    if (newLhs != lhs)
    {
      ...
      if (lhs != null)
        msgs = ((InternalEObject)lhs).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - JPQLPackage.IN_EXPRESSION__LHS, null, msgs);
      if (newLhs != null)
        msgs = ((InternalEObject)newLhs).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - JPQLPackage.IN_EXPRESSION__LHS, null, msgs);
      msgs = basicSetLhs(newLhs, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, JPQLPackage.IN_EXPRESSION__LHS, newLhs, newLhs));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case JPQLPackage.IN_EXPRESSION__LHS:
