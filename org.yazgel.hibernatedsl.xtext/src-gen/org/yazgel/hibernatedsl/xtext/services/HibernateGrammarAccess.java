...
* generated by Xtext
*/
package org.yazgel.hibernatedsl.xtext.services;
...
@Singleton
public class HibernateGrammarAccess extends AbstractGrammarElementFinder {
	...
	@Inject
	public HibernateGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("org.yazgel.hibernatedsl.xtext.Hibernate".equals(grammar.getName())) {
				return grammar;
			}
