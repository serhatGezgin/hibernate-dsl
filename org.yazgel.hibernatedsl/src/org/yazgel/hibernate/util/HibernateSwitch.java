/**
 */
package org.yazgel.hibernate.util;
 ...
 * <!-- end-user-doc -->
 * @see org.yazgel.hibernate.HibernatePackage
 * @generated
 */
public class HibernateSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case HibernatePackage.PACKAGE: {
				org.yazgel.hibernate.Package package_ = (org.yazgel.hibernate.Package)theEObject;
				T result = casePackage(package_);
				if (result == null) result = caseNamedElement(package_);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case HibernatePackage.NAMED_ELEMENT: {
	 ...
	 * @generated
	 */
	public T casePackage(org.yazgel.hibernate.Package object) {
		return null;
	}
