 ...
 * <ul>
 *   <li>{@link org.yazgel.hibernate.impl.DataTypeImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class DataTypeImpl extends FeatureImpl implements DataType {
	...
	protected EClass eStaticClass() {
		return HibernatePackage.Literals.DATA_TYPE;
	}
	...
	public void setType(DataTypes newType) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HibernatePackage.DATA_TYPE__TYPE, oldType, type));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HibernatePackage.DATA_TYPE__TYPE:
				return getType();
		}
