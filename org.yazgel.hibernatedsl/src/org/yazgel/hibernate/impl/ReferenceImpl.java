 ...
 * <ul>
 *   <li>{@link org.yazgel.hibernate.impl.ReferenceImpl#getReference <em>Reference</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ReferenceImpl extends FeatureImpl implements Reference {
	...
	protected EClass eStaticClass() {
		return HibernatePackage.Literals.REFERENCE;
	}
		...
		if (reference != null && reference.eIsProxy()) {
			...
			if (reference != oldReference) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, HibernatePackage.REFERENCE__REFERENCE, oldReference, reference));
			}
		}
		return reference;
	}
	...
	public void setReference(Entity newReference) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, HibernatePackage.REFERENCE__REFERENCE, oldReference, reference));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case HibernatePackage.REFERENCE__REFERENCE:
