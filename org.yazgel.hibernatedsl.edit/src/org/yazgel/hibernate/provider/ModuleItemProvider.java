...
/**
 * This is the item provider adapter for a {@link org.yazgel.hibernate.Module} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class ModuleItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HibernatePackage.Literals.MODULE__PACKAGES);
		}
	...
	public void notifyChanged(Notification notification) {
		...
		switch (notification.getFeatureID(Module.class)) {
			case HibernatePackage.MODULE__PACKAGES:
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HibernatePackage.Literals.MODULE__PACKAGES,
				 HibernateFactory.eINSTANCE.createPackage()));
	}
