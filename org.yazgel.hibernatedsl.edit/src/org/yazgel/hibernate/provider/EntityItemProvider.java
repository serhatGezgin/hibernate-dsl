/**
 */
package org.yazgel.hibernate.provider;
...
/**
 * This is the item provider adapter for a {@link org.yazgel.hibernate.Entity} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class EntityItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HibernatePackage.Literals.ENTITY__SUPER_ENTITY,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 HibernatePackage.Literals.ENTITY__ANNOTATIONS,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(HibernatePackage.Literals.ENTITY__FEATURES);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(HibernatePackage.Literals.ENTITY__FEATURES,
				 HibernateFactory.eINSTANCE.createReference()));

		newChildDescriptors.add
			(createChildParameter
				(HibernatePackage.Literals.ENTITY__FEATURES,
				 HibernateFactory.eINSTANCE.createDataType()));
	}
